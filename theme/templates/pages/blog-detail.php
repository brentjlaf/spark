    ...
    <div id="app" class="page-template default-page d-flex flex-column min-vh-100">
        ...
        <main id="main-area" class="flex-grow-1">
            <section class="py-5 bg-light border-bottom">
                <div class="container">
                    <a class="text-decoration-none text-primary small fw-semibold" href="<?php echo htmlspecialchars($backUrl); ?>">
                        <i class="fas fa-arrow-left me-2"></i>
                        Back to all posts
                    </a>
                    <?php if ($detailCategory !== ''): ?>
                    <span class="d-inline-block text-uppercase text-primary fw-semibold small mt-3"><?php echo htmlspecialchars($detailCategory); ?></span>
                    <?php endif; ?>
                    <h1 class="display-5 fw-bold mt-2"><?php echo htmlspecialchars($detailTitle); ?></h1>
                    <?php if ($detailAuthor !== '' || $detailDate !== ''): ?>
                    <div class="text-muted mt-3">
                        <?php if ($detailAuthor !== ''): ?>
                        <span class="me-3"><i class="fas fa-user me-1"></i><?php echo htmlspecialchars($detailAuthor); ?></span>
                        <?php endif; ?>
                        <?php if ($detailDate !== ''): ?>
                        <span><i class="far fa-calendar-alt me-1"></i><?php echo htmlspecialchars($detailDate); ?></span>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                </div>
            ...
            <section class="py-5">
                <div class="container">
                    <article class="mx-auto" style="max-width: 760px;">
                        <div class="mw-rich-text blog-detail-content fs-5">
                            <?php echo $detailContent; ?>
                        </div>
                        <?php if ($detailTags): ?>
                        <div class="mt-5">
                            <span class="text-uppercase text-muted small fw-semibold">Tags</span>
                            <div class="mt-2">
                                <?php foreach ($detailTags as $tag): ?>
                                <span class="badge bg-light text-primary border me-2 mb-2">#<?php echo htmlspecialchars($tag); ?></span>
                                <?php endforeach; ?>
                            </div>
                        </div>
                        <?php endif; ?>
