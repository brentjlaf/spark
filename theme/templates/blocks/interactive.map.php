...
<section id="<?= $blockId ?>" class="map-block" data-tpl-tooltip="Map" data-map-block data-map-height="{custom_map_height}" data-map-show-list="{custom_show_list}" data-map-categories="{custom_category_filter}" data-map-default-zoom="{custom_default_zoom}" data-map-empty="{custom_empty}">
    <div class="container">
        <div class="map-block__header text-center mb-4">
            <h2 class="map-block__heading" data-editable>{custom_title}</h2>
            <p class="map-block__intro text-muted" data-editable>{custom_intro}</p>
        </div>
        ...
        <div class="map-block__empty text-center text-muted d-none" data-map-empty role="status" aria-live="polite">{custom_empty}</div>
    </div>
</section>
