...
<section id="<?= $blockId ?>" class="blog-post-detail py-5" data-tpl-tooltip="Post Details" data-blog-detail data-back-base="{custom_back_base}" data-back-label="{custom_back_label}" data-show-back-link="{custom_show_back_link}" data-show-back-button="{custom_show_back_button}" data-show-category="{custom_show_category}" data-show-author="{custom_show_author}" data-show-date="{custom_show_date}" data-show-tags="{custom_show_tags}" data-show-featured="{custom_show_featured}" data-loading-text="{custom_loading_text}" data-empty="{custom_empty}" data-slug="{custom_slug}">
    <div class="container">
        ...
        <div class="blog-post-detail__body" data-blog-detail-main>
            <nav class="blog-post-detail__back mb-4" aria-label="Back to blog" data-blog-detail-back-wrapper>
            ...
            <header class="blog-post-detail__header">
                <span class="blog-post-detail__category badge bg-primary-subtle text-primary" data-blog-detail-category>Category</span>
                <h1 class="blog-post-detail__title" data-blog-detail-title>Post title appears here</h1>
                <div class="blog-post-detail__meta text-muted" data-blog-detail-meta>
            ...
            <figure class="blog-post-detail__featured mt-4 mb-4" data-blog-detail-featured>
            ...
            <div class="blog-post-detail__tags mt-5" data-blog-detail-tags>
                <span class="blog-post-detail__tags-label text-uppercase small fw-semibold">Tags</span>
                <div class="blog-post-detail__tags-list mt-2" data-blog-detail-tags-list>
                    <span class="blog-post-detail__tag badge bg-light text-primary border me-2 mb-2">#example</span>
                    <span class="blog-post-detail__tag badge bg-light text-primary border me-2 mb-2">#placeholder</span>
                </div>
            </div>
            <div class="blog-post-detail__actions mt-5" data-blog-detail-actions>
                <a class="btn btn-outline-primary blog-post-detail__back-button" href="{custom_back_base}" data-blog-detail-back-secondary>
                    <i class="fas fa-arrow-left me-2" aria-hidden="true"></i>
