...
<div class="content-section" id="maps">
    <div class="a11y-dashboard maps-dashboard" id="mapsModule" data-initial="<?php echo $initialAttr; ?>">
        <header class="a11y-hero maps-hero">
            <div class="a11y-hero-content">
                <div>
                    <span class="hero-eyebrow">Location intelligence</span>
                    <h2 class="a11y-hero-title">Maps &amp; Locations</h2>
                    <p class="a11y-hero-subtitle">Curate a trusted directory of places your visitors can explore on your site and embedded maps.</p>
                </div>
            ...
            <div class="a11y-overview-grid maps-overview">
        ...
        <section class="maps-layout">
            <div class="a11y-detail-card maps-locations-card">
                <header class="maps-card-header">
                    ...
                    <div class="maps-card-actions">
                        ...
                        <div class="maps-filter-group" role="group" aria-label="Location filters">
                            <select id="mapCategoryFilter" class="a11y-sort-select" aria-label="Filter by category">
                            ...
                            <select id="mapStatusFilter" class="a11y-sort-select" aria-label="Filter by status">
                ...
                <div class="a11y-table-view maps-table" aria-live="polite">
                    <div class="a11y-table-header maps-table__header">
                        <div>Name</div>
                        <div>Status</div>
                        <div>Location</div>
                        <div>Categories</div>
            ...
            <aside class="maps-sidebar">
                <section class="a11y-detail-card maps-categories-card">
                    <header class="maps-card-header">
                        <div>
